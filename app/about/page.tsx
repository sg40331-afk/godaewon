...
export default function About() {
  return <><SiteHeader /><main>
    <div className="sub-hero about-subhero"><div className="site-container subhero-layout"><div className="subhero-copy"><span className="kicker">ABOUT TAX ACCOUNTANT</span><h1>고대원 세무사를<br />소개합니다</h1><p>사장님이 이해하고 판단할 수 있도록 어려운 세무를 쉬운 말로 설명하는 든든한 사업 파트너입니다.</p><div className="subhero-chips"><span>쉬운 설명</span><span>정확한 신고</span><span>사업 맞춤 상담</span></div></div><div className="about-title-visual"><div className="about-title-photo"><img src="/godaewon-profile.png" alt="고대원 세무사" /></div><div className="about-title-card"><small>TAX PARTNER</small><strong>고대원 대표 세무사</strong><span>사업과 자산의 세금 문제를 함께합니다</span></div></div></div></div>
