...
import { ArrowRight, Calculator, Check, ClipboardCheck, MessageSquareText } from "lucide-react"
import { SiteFooter, SiteHeader } from "@/components/site-shell"

const services = [
  {
    n: "01", t: "기장 및 세무신고", k: "매달 사업 숫자를 정확하게", tone: "mint",
    image: "/service-bookkeeping.webp", alt: "장부, 영수증, 계산기로 구성한 기장 및 세무신고 이미지",
  ...
  {
    n: "02", t: "급여·원천세·4대보험", k: "첫 직원 채용도 막힘없이", tone: "blue",
    image: "/service-payroll.webp", alt: "급여 자료와 달력으로 구성한 원천세 및 4대보험 이미지",
  ...
  {
    n: "03", t: "창업 세무상담", k: "사업 시작 전부터 든든하게", tone: "orange",
    image: "/service-startup.webp", alt: "사업계획서, 열쇠, 계산기로 구성한 창업 세무상담 이미지",
  ...
  {
    n: "04", t: "법인 전환 및 절세 검토", k: "성장 속도에 맞는 세무 전략", tone: "navy",
    image: "/service-corporate.webp", alt: "기업 자료와 재무 그래프로 구성한 법인 전환 및 절세 이미지",
